...
return [
    CourierEnum::PATHAO->value    => [
        'fraud_check_enable' => env('PATHAO_FRAUD_CHECK_ENABLE', true),
        'parcel_enable'      => env('PATHAO_PARCEL_ENABLE', false),
        'outgoing'           => [
        ...
        'incoming'           => [
            ...
            'status_map'          => [
                ...
                'order.returned'                  => OrderStatusEnum::RETURNED->value,
    ...
    CourierEnum::REDX->value      => [
        'fraud_check_enable' => env('REDX_FRAUD_CHECK_ENABLE', true),
        'parcel_enable'      => env('REDX_PARCEL_ENABLE', false),
        'outgoing'           => [
    ...
    CourierEnum::STEADFAST->value => [
        'fraud_check_enable' => env('STEADFAST_FRAUD_CHECK_ENABLE', true),
        'parcel_enable'      => env('STEADFAST_PARCEL_ENABLE', false),
    ...
    CourierEnum::CARRYBEE->value  => [
        'fraud_check_enable' => env('CARRYBEE_FRAUD_CHECK_ENABLE', true),
        'parcel_enable'      => env('CARRYBEE_PARCEL_ENABLE', false),
        'outgoing'           => [
